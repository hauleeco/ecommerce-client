            ...
            <div className="col-lg-5 offset-lg-1 col-md-12 order-1 order-lg-2">
              <div className="contact-page-side-content">
                ...
                <p className="contact-page-message mb-25">
                  Ecommerce Shop is understood as an e-commerce store specializing in selling art products.
                </p>
                <div className="single-contact-block">
                  <h4>
                    <i className="fa fa-fax" /> Address
                  </h4>
                  <p>9/1A - Giai phong - F4 - Tan Binh – Ho Chi Minh - VN</p>
                </div>
                <div className="single-contact-block">
                  <h4>
                    <i className="fa fa-phone" /> Phone
                  </h4>
                  <p>Mobile: (+84) 943 125 585</p>
